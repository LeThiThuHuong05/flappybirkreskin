...
export default class NewClass extends cc.Component {
    ...
    initPos() {
        ...
        let gap = random(250, 400) // 可以通过的区域
        ...
        this.coin.node.y = (screenH / 2 - h1) - random (gap*0.35, gap*0.65);
        // console.log({ h1, y1 })
        ...
        const physicsBox3 = this.coin.getComponent(cc.PhysicsBoxCollider)
        physicsBox3.size = this.coin.node.getContentSize()
        physicsBox3.offset = cc.v2(0, 0);
        physicsBox3.apply()
    }
    ...
    update(dt) {
        ...
        this.coin.getComponent(cc.RigidBody).syncPosition(true);
